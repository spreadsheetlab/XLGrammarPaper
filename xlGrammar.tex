...
\begin{itemize}
	\item 3,276 cases of external file references without cell targets, e.g. \texttt{=[1]!'SGJ200,LA'}. The grammar will provide support for those cases once we understand what those formulas mean and how they are evaluated from Excel.
