...
Unfortunately there is not correct choice, In a formula like \texttt{=SUM(A1,1)} the parser must reduce on the \synt{Argument} nonterminal, while in a formula like \texttt{=A1,A1} the parser must reduce to the \synt{Union} nonterminal.
...
This is a trade-off between our a lower compatibility (design goal 1) and an easier implementation (design goal 3).
...
If your implementation or parser can support the more straightforward definition we recommend altering the grammar on this point.
