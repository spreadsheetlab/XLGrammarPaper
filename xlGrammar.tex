...
- grammar changes with different Excel versions, eg regular expressions support, labels in formulas now expanded to cell references
...
\section{Grammar discussion / coverage / notable cases}
...
Not covering array formulas (?), pivot tables(?)
