...
In the following sections, for each of the research questions, we describe the results obtained through the analysis of the 8,576,969 unique formulas in the dataset.

\subsection{Formula size and complexity}
 What are the size and complexity characteristics of Excel formulas?
 \noindent
 \fbox{
...
\subsubsection{Complexity of formulas}

The complexity of the formulas in terms of invoked functions and operations is reflected in the structure of the produced parse trees. To demonstrate how the parse trees can be used for analyzing formula characteristics, we calculated three formula complexity indicators:  the conditional depth, the formula depth, and the operator depth. The results, in terms of number of unique formulas, are plotted in Figure \ref{Figure:depths}.
